...
"""
dNG.pas.plugins.database.pas_database_ownable
"""
"""n// NOTE
----------------------------------------------------------------------------
direct PAS
...
:since:  v0.1.00
	...
	NamedLoader.get_instance("dNG.pas.database.instances.AclEntry")
	NamedLoader.get_instance("dNG.pas.database.instances.Permission")
